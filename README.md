1. One of the serious I had in the project was Integrity error, unique constraint failed. And I got this solved by changing my model User which was inheriting from EmailAbstactUser.
